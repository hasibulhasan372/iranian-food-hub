...
const Chef = () => {
    ...
    return (
        <div className='my-container m-auto pt-6 lg:pt-0 lg:mt-20 pb-10 lg:pb-16'>
            <div className='lg:mb-10 text-center'>
            <h2 className=' text-[#cc3333] text-xl font-bold font-serif'>Our Chefs</h2>
            <h4 className='capitalize text-[#292929] text-xl lg:text-4xl font-bold my-4'>The Best <span className='text-yellow-600'>Iranian Chefs</span> in Town</h4>
            </div>
            <div>
            {
                loading ? 
