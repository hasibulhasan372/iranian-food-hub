    ...
    return (
        <section className='pt-10'>
            ...
            <div  className=''>
                    ...
                    <h2 className='capitalize text-[#292929] text-4xl font-bold my-4 text-center lg:text-left'>Why we are the best</h2>
                ...
                <div className='grid gap-4 lg:gap-2 grid-cols-2'>
